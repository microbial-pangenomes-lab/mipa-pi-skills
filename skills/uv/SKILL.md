...
This skill is adapted from the [astral-sh/claude-code-plugins](https://github.com/astral-sh/claude-code-plugins/blob/main/plugins/astral/skills/uv/SKILL.md) project, licensed under Apache-2.0.

(c) Astral Software Inc.